...
import CustomPage from 'Route/CustomPage';
import {
    Breadcrumbs,
    CartPage,
    Checkout,
...
export class RouterComponent extends SourceRouter {
  ...
  [SWITCH_ITEMS_TYPE] = [
      ...
      },
      {
          component: (
        <Route
          path={ withStoreRegex('/about-us-page') }
          exact
      ...
      },
      {
          component: (
      <Route
        path={ withStoreRegex('/custom-page') }
        exact
      ...
      {
          component: <Route path={ withStoreRegex('/sales/order/view/order_id/:orderId?') } render={ (props) => <MyAccount { ...props } /> } />,
          position: 70
      },
      {
          component: <Route path={ withStoreRegex('/sales/order/history') } render={ (props) => <MyAccount { ...props } /> } />,
          position: 71
      },
      {
          component: <Route path={ withStoreRegex('/downloadable/customer/products') } render={ (props) => <MyAccount { ...props } /> } />,
          position: 72
      },
      {
          component: <Route path={ withStoreRegex('/wishlist') } render={ (props) => <MyAccount { ...props } /> } />,
          position: 73
      },
      {
          component: <Route path={ withStoreRegex('/customer/address') } render={ (props) => <MyAccount { ...props } /> } />,
          position: 74
      },
      {
          component: <Route path={ withStoreRegex('/newsletter/manage') } render={ (props) => <MyAccount { ...props } /> } />,
          position: 75
      },
      {
      ...
      {
          component: <Route path={ withStoreRegex('/sales/order/printInvoice/order_id/:orderId?') } render={ (props) => <OrderPrintPage { ...props } /> } />,
          position: 91
      },
      {
          component: <Route path={ withStoreRegex('/sales/order/printShipment/order_id/:orderId?') } render={ (props) => <OrderPrintPage { ...props } /> } />,
          position: 92
      },
      {
          component: <Route path={ withStoreRegex('/sales/order/printCreditmemo/order_id/:orderId?') } render={ (props) => <OrderPrintPage { ...props } /> } />,
          position: 93
      },
      {
          component: <Route path={ withStoreRegex('/sales/order/printInvoice/invoice_id/:invoiceId?') } render={ (props) => <OrderPrintPage { ...props } /> } />,
          position: 94
      },
      {
          component: <Route path={ withStoreRegex('/sales/order/printShipment/shipment_id/:shipmentId?') } render={ (props) => <OrderPrintPage { ...props } /> } />,
          position: 95
      },
      {
          component: <Route path={ withStoreRegex('/sales/order/printCreditmemo/creditmemo_id/:refundId?') } render={ (props) => <OrderPrintPage { ...props } /> } />,
          position: 95
      },
      {
